            ...
            <div class="container">
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-5 text-center mx-auto">
                        ...
                        <h5 class="text-lead text-white"><a href="https://github.com/flaviusmatis/simplePagination.js" class="font-weight-bold" target="_blank" style="color: #0c9ab4">@flaviusmatis</a></h5>
                    </div>
                </div>
            </div>
        </div>
