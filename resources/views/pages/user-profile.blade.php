                ...
                <div class="card">
                    ...
                    <div id='Customer_View2'>
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    <img src="/img/profile/{{ Auth::user()->pp_path }}" width="20%">
                                </div>
                                <div class="col-sm">
                                    <form role="form" method="POST" action="{{ route('profile_ppicture') }}" enctype="multipart/form-data">
                                        @csrf
                ...
                <div class="card card-profile">
                    ...
                    <div class="card-header text-center">
                        <div class="d-flex justify-content-center" style="">
                            ...
                            <a href="javascript:;"
                                class="btn btn-sm btn-dark float-right mb-0 d-none d-lg-block">Change Picture</a>
                        </div>
                    </div>
