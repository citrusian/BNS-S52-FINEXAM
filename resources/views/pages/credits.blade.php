            ...
            <div class="container">
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-5 text-center mx-auto">
                        ...
                        <h3 class="text-lead text-white">&nbsp</h3>
                        <h4 class="text-lead text-white">Script:</h4>
                        <h5 class="text-lead text-white">Sweet Alert 2</h5>

                        <h5 class="text-lead text-white">
                            <a href="https://github.com/sweetalert2/sweetalert2" class="font-weight-bold" target="_blank" style="color: #0c9ab4">Sweet Alert 2</a>
                        </h5>
