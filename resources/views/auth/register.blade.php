...
{{--            style="background-image: url('https://raw.githubusercontent.com/creativetimofficial/public-assets/master/argon-dashboard-pro/assets/img/signup-cover.jpg'); background-position: top; height: 95vh;">--}}
        <div class="page-header align-items-start pt-5 pb-11 m-3 border-radius-lg"
{{--        <div class="page-header min-vh-96 border-radius-lg  m-4"--}}
